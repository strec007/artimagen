...
enum t_aig_lua_err {
   AIG_LUA_ERR_NUMBER_OF_ARGUMENTS = -999,
   AIG_LUA_ERR_ARGUMENT_TYPE,
   ...
   AIG_LUA_ERR_FATAL,
   AIG_LUA_ERR_BG_IM_TOO_SMALL,
   AIG_LUA_ERR_POISSON_LAMBDA,
   AIG_LUA_ERR_CANNOT_READ_FILE,
   AIG_LUA_ERR_CANNOT_WRITE_FILE
};
