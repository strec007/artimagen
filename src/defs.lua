...
vibs={}
table.insert(vibs,{0.419685, 0.419685, 94.9867, 1.259}) 
table.insert(vibs,{0.100004, 0.100004, 35.3848, 1.09606}) 
table.insert(vibs,{-0.0518315, -0.0518315, 84.1115, 2.62039}) 
table.insert(vibs,{-0.181976, -0.181976, 86.6691, 3.07082}) 
table.insert(vibs,{-0.627605, -0.627605, 56.5956, -2.90952}) 
table.insert(vibs,{0.492469, 0.492469, 99.0336, 0.0556326}) 
table.insert(vibs,{-0.60102, -0.60102, 68.3686, -2.75395}) 
table.insert(vibs,{0.496194, 0.496194, 93.4821, -2.75638}) 
table.insert(vibs,{0.552143, 0.552143, 76.4069, -2.8643}) 
table.insert(vibs,{-0.894913, -0.894913, 72.1391, -0.72543}) 
